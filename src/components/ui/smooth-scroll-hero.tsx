        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6 py-8 overflow-y-auto max-h-screen">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Запишись на первую тренировку сегодня — и уже через месяц
              <br className="hidden md:block" />
              ты увидишь, на что способно твоё тело.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Программ тренировок</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">В неделю открыты</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">На рынке</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">НАМ ДОВЕРЯЮТ В ГОРОДЕ</p>
